<?php
     $sql_pro = "SELECT * FROM product,category WHERE product.id_danhmuc = category.id_danhmuc AND category.tendanhmuc LIKE '%Thời trang nam%' LIMIT 4";
...
<div class="list-product">
            ...
            <div  class="view-link">
                     <a href="index.php?quanly=thoitrangnam&id=<?php echo $id_danhmuc?>" class="view"><span>Xem thêm</span></a>
                </div>
</div>
